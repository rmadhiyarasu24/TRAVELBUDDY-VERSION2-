  ...
  return (
    <div className="relative w-full h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center animate-fade-in-up">
        ...
        <div className="inline-flex flex-col md:flex-row items-center gap-2 px-6 py-3 rounded-full bg-white/80 dark:bg-black/30 border border-gray-200 dark:border-white/10 text-indigo-600 dark:text-indigo-300 text-sm font-bold mb-10 shadow-lg backdrop-blur-md animate-float">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tight mb-6 text-gray-900 dark:text-white drop-shadow-sm">
          Plan Your Next <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 drop-shadow-xl">
            Dream Adventure
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <button
            ...
            className="px-10 py-5 bg-indigo-600 dark:bg-white text-white dark:text-neutral-900 rounded-2xl font-black text-xl hover:bg-indigo-700 dark:hover:bg-gray-100 transition-all shadow-2xl shadow-indigo-600/30 hover:-translate-y-1 active:scale-95 border-2 border-transparent"
          >
            Start Planning Now 🌍
          </button>
